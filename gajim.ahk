...
<title>raise_on_message/gajim.ahk · master · dan drum / gajim-plugins · GitLab</title>
<script>
//<![CDATA[
...
gl.startup_graphql_calls = [{"query":"query getBlobInfo(\n  $projectPath: ID!\n  $filePath: [String!]!\n  $ref: String!\n  $refType: RefType\n  $shouldFetchRawText: Boolean!\n) {\n  project(fullPath: $projectPath) {\n    __typename\n    id\n    repository {\n      __typename\n      empty\n      blobs(paths: $filePath, ref: $ref, refType: $refType) {\n        __typename\n        nodes {\n          __typename\n          id\n          webPath\n          name\n          size\n          rawSize\n          rawTextBlob @include(if: $shouldFetchRawText)\n          fileType\n          language\n          path\n          blamePath\n          editBlobPath\n          gitpodBlobUrl\n          ideEditPath\n          forkAndEditPath\n          ideForkAndEditPath\n          codeNavigationPath\n          projectBlobPathRoot\n          forkAndViewPath\n          environmentFormattedExternalUrl\n          environmentExternalUrlForRouteMap\n          canModifyBlob\n          canModifyBlobWithWebIde\n          canCurrentUserPushToBranch\n          archived\n          storedExternally\n          externalStorage\n          externalStorageUrl\n          rawPath\n          replacePath\n          pipelineEditorPath\n          simpleViewer {\n            fileType\n            tooLarge\n            type\n            renderError\n          }\n          richViewer {\n            fileType\n            tooLarge\n            type\n            renderError\n          }\n        }\n      }\n    }\n  }\n}\n","variables":{"projectPath":"4q1/gajim-plugins","ref":"master","refType":null,"filePath":"raise_on_message/gajim.ahk","shouldFetchRawText":true}}];
...
if (gl.startup_graphql_calls && window.fetch) {
  const headers = {"X-CSRF-Token":"H3VPoA38oxcUH4euW6owpwxVR-vtzqkgVMWZPqlHDpfxYYQysSq0JZE5bXjJlg8ClGoHMLcXjcIgfLguE_11Zw","x-gitlab-feature-category":"source_code_management"};
...
<meta content="raise_on_message/gajim.ahk · master · dan drum / gajim-plugins · GitLab" property="og:title">
...
<meta content="https://dev.gajim.org/4q1/gajim-plugins/-/blob/master/raise_on_message/gajim.ahk" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="raise_on_message/gajim.ahk · master · dan drum / gajim-plugins · GitLab" property="twitter:title">
...
<meta name="csrf-token" content="36PbQvYe1Uwr5xEnH0UMidlL29RY2PAHKNaiJP5FCpcxtxDQSsjCfq7B-_GNeTMsQXSbDwIB1OVcb4M0RP9xZw" />
<meta name="csp-nonce" />
...
<body class="tab-width-8 gl-browser-firefox gl-platform-windows" data-namespace-id="51989" data-page="projects:blob:show" data-page-type-id="master/raise_on_message/gajim.ahk" data-project="gajim-plugins" data-project-full-path="4q1/gajim-plugins" data-project-id="418">
...
{"@context":"https://schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"dan drum","item":"https://dev.gajim.org/4q1"},{"@type":"ListItem","position":2,"name":"gajim-plugins","item":"https://dev.gajim.org/4q1/gajim-plugins"},{"@type":"ListItem","position":3,"name":"Repository","item":"https://dev.gajim.org/4q1/gajim-plugins/-/blob/master/raise_on_message/gajim.ahk"}]}


</script>
<div data-testid="breadcrumb-links" id="js-vue-page-breadcrumbs-wrapper">
<div data-breadcrumbs-json="[{&quot;text&quot;:&quot;dan drum&quot;,&quot;href&quot;:&quot;/4q1&quot;,&quot;avatarPath&quot;:null},{&quot;text&quot;:&quot;gajim-plugins&quot;,&quot;href&quot;:&quot;/4q1/gajim-plugins&quot;,&quot;avatarPath&quot;:null},{&quot;text&quot;:&quot;Repository&quot;,&quot;href&quot;:&quot;/4q1/gajim-plugins/-/blob/master/raise_on_message/gajim.ahk&quot;,&quot;avatarPath&quot;:null}]" id="js-vue-page-breadcrumbs"></div>
...
<div class="js-signature-container" data-signatures-path="/4q1/gajim-plugins/-/commits/e3ab0eccdc3ba3fcdf5f5a32490a59c156c38c5d/signatures?limit=1"></div>
...
<li class="breadcrumb-item">
<a href="/4q1/gajim-plugins/-/blob/master/raise_on_message/gajim.ahk"><strong>gajim.ahk</strong>
</a></li>
</ul>
</div>
...
<a data-event-tracking="click_blame_control_on_blob_page" class="gl-button btn btn-md btn-default js-blob-blame-link" href="/4q1/gajim-plugins/-/blame/master/raise_on_message/gajim.ahk"><span class="gl-button-text">
Blame
</span>

</a>
<a aria-keyshortcuts="y" class="gl-button btn btn-md btn-default has-tooltip js-data-file-blob-permalink-url" data-html="true" title="Go to permalink &lt;kbd class=&#39;flat ml-1&#39; aria-hidden=true&gt;y&lt;/kbd&gt;" href="/4q1/gajim-plugins/-/blob/f191367db3392fa89d070781c5472133e3e5a5fa/raise_on_message/gajim.ahk"><span class="gl-button-text">
Permalink
</span>
...
<li class="commit flex-row js-toggle-container" id="commit-e3ab0ecc">
...
<a class="commit-row-message item-title js-onboarding-commit-item " href="/4q1/gajim-plugins/-/commit/e3ab0eccdc3ba3fcdf5f5a32490a59c156c38c5d">Upload New File</a>
<span class="commit-row-message d-inline d-sm-none">
&middot;
e3ab0ecc
</span>
<div class="committer gl-text-sm">
<a class="commit-author-link js-user-link" data-user-id="51806" href="/4q1">dan drum</a> authored <time class="js-timeago" title="Mar 14, 2026 2:21am" datetime="2026-03-14T02:21:31Z" data-toggle="tooltip" data-placement="bottom" data-container="body">Mar 14, 2026</time>
</div>
...
<div class="js-commit-pipeline-status" data-endpoint="/4q1/gajim-plugins/-/commit/e3ab0eccdc3ba3fcdf5f5a32490a59c156c38c5d/pipelines?ref=master"></div>
<div class="commit-sha-group btn-group gl-hidden sm:gl-flex">
<div class="label label-monospace monospace">
e3ab0ecc
</div>
<button class="gl-button btn btn-icon btn-md btn-default " title="Copy commit SHA" aria-label="Copy commit SHA" aria-live="polite" data-toggle="tooltip" data-placement="bottom" data-container="body" data-html="true" data-category="primary" data-size="medium" data-clipboard-text="e3ab0eccdc3ba3fcdf5f5a32490a59c156c38c5d" type="button"><svg class="s16 gl-icon gl-button-icon " data-testid="copy-to-clipboard-icon"><use href="/assets/icons-8791a66659d025e0a4c801978c79a1fbd82db1d27d85f044a35728ea7cf0ae80.svg#copy-to-clipboard"></use></svg>
...
<div data-event-tracking="click_history_control_on_blob_page" data-history-link="/4q1/gajim-plugins/-/commits/master/raise_on_message/gajim.ahk" id="js-commit-history-link"></div>
</div>
</div>
<div class="gl-block sm:gl-hidden">
...
<div data-blob-path="raise_on_message/gajim.ahk" data-can-download-code="true" data-original-branch="master" data-project-path="4q1/gajim-plugins" data-ref-type="" data-resource-id="gid://gitlab/Project/418" data-target-branch="master" data-user-id="gid://gitlab/User/51806" id="js-view-blob-app">
...
//<![CDATA[
  window.gl = window.gl || {};
  window.gl.webIDEPath = '/-/ide/project/4q1/gajim-plugins/edit/master/-/raise_on_message/gajim.ahk'
